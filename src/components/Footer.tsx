      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            <h3 className="footer-title">TechVision Solutions</h3>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link href="/services">Desktop Software</Link></li>
        ...
        <div className="footer-bottom">
          <p className="copyright">
            © <span className="current-year">{currentYear}</span> TechVision Solutions. All rights reserved.
          </p>
